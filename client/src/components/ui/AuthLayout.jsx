...
export default function AuthLayout({ children }) {
  return (
    <>
      {/* Background */}
      <div class="absolute inset-0 -z-10 h-full w-full bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_2px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_2px)] bg-[size:5rem_5rem]"></div>
      {/* Title */}
